...
from cloudymusic.core import call, tg, db, config
...
class Bot(Client):
    ...
    def __init__(self) -> None:
        ...
        super().__init__(
            ...
            plugins=types.plugins.Plugins(folder="cloudymusic/modules"),
            files_directory="",
    ...
    def _initialize_services(self) -> None:
        ...
        from cloudymusic.modules.jobs import InactiveCallManager
        self.config = config
        self.db = db
        self.call = call
        self.tg = tg
    ...
    async def _initialize_components(self) -> None:
        from cloudymusic.core import save_all_cookies
