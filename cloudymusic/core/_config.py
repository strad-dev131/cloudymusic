...
class BotConfig:
    ...
    def __init__(self):
        ...
        # Owner and Logger
        self.OWNER_ID: int = self._get_env_int("OWNER_ID", 7784241637)
        self.LOGGER_ID: int = self._get_env_int("LOGGER_ID", -1002715747653)
        ...
        self.SUPPORT_GROUP: str = os.getenv(
            "SUPPORT_GROUP", "https://t.me/TeamsXchat"
        )
        self.SUPPORT_CHANNEL: str = os.getenv(
            "SUPPORT_CHANNEL", "https://t.me/TeamXUpdate"
        )
